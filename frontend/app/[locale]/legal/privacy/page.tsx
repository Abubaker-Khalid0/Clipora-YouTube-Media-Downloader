...
/**
 * Privacy Policy stub page — /[locale]/legal/privacy
 *
 * Design reference (contracts/ui-contracts.md §Stub Pages):
 *   glass-panel rounded-3xl p-12 bg-background-light
 *   heading: text-primary font-extrabold
 *
 * FR-008, SC-003 — Returns HTTP 200 (no 404), matches landing page design.
 */
